...
.btn{
    ...
    margin-left: 200px;
         ...
         footer {
            ...
            text-align: center;
            color: white;
            margin-top: 68%;   /* Ito yung ieedit para pumantay yung footer sa haba ng page */
...
<?php include 'Template/Teacher/Navigation.php';?>   <!-- Connection para sa templete ng Navigation bar-->
    <section>
        <nav>
            <div class="container-left">
                <br>
                <a href="teacher-homepage.php"><i class="fa-solid fa-arrow-left"></i> Home Page </a>
                <br><br>
                <hr style="width: 70%">
                <br><br>
                <a href="teacher-profile.php"><b>Personal Information</b> </a>
                <br><br>
                <hr style="width: 70%">
                <br><br>
                <a href="teacher-password.php">Password </a>
                    <br><br>
                    <hr style="width: 70%">
